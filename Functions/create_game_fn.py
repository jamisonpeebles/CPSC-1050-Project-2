...
def init_game(map, logbook):
    #adds room to map object along with all the attributes needed for a Room object
    ...
    #uses a loop to assign elements of the ingredient_info.csv file to Ingredient objects and then store those objects within the storage room
    ...
    ''' old code that was for a different structure idea
