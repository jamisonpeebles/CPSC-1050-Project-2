...
def main():
    ...
    while True:
        ...
        while True: 
            print('What would you like to do? (exit room / read logbook / use held item / throw away held item / take item from storage room))')
                ...
                if type(user.held_item) != type(None):
                    ...
                    while True:
                        ...
                        if item_choice == 'dry item':
                            ...
                            potion.add_ingredient(user.held_item, user)
                            user.held_item = None
                            break
